...
public class Main {
    ...
    // method to read file data for account creation
    public static void loadTradeAccounts() throws IOException{
        Files.lines(paths[0])
        // for each line, split into array of strings and create CashAccount or MarginAccount object
        // add related account to corresponding account service
            .forEach(line -> {
    ...
    // method to read file data for transactions
    public static void applyTransactions() throws IOException{
        Files.lines(paths[1])
        .forEach(line ->{
            // for each line, split into array of strings
            String[] words = line.split(" ");
            ...
            // use appropriate account service to update amount
